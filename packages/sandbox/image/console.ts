...
export default function (pi: ExtensionAPI): void {
	pi.registerTool({
		...
		description: [
			...
			"",
			"When a request comes back refused with egress_denied, that is the proxy and not the site.",
			"Ask for /reach with the host out of the URL. It opens nothing by itself: it puts the host on",
			"your operator's screen as a question they answer with one key, and you are told what they",
			"said. That is the whole of asking for reach — do not also write a paragraph about it.",
			"",
		...
		promptGuidelines: [
			...
			"When a fetch fails with egress_denied, ask for /reach on that host and pair it with wake_me. Asking is the whole of what you can do about it: never tell the operator to go and edit an allowlist, because the question you file is already the screen they answer.",
