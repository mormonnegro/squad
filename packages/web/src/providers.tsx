...
export const LOOK: Readonly<Record<string, Look>> = {
	deepseek: {
		name: "DeepSeek",
		says: "Cheap enough to leave running. Where the config starts.",
	...
	anthropic: {
		name: "Anthropic",
		says: "Claude. The best of these at long, careful work.",
	...
	openai: {
		name: "OpenAI",
		says: "GPT. Also what web search runs on.",
