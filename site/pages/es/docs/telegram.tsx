...
`}</Screen>
			...
			<section>
				...
				<p>
					...
					<Link href="/es/docs/trust/">participant</Link>, fenced like any other stranger — what
					they write arrives as data with a name on it rather than as an instruction, however it is
