		...
		>
			...
			<section>
				...
				<p className="small muted">
					...
					attacker present to notice or revoke. <Link href="/docs/schedules/">Schedules</Link> is
					the rest of that.
				</p>
			</section>
...
`}</Screen>
			...
			<section>
				...
				<p>
					...
					<Link href="/docs/grants/">any grant broad enough to be useful</Link>, and it is why the
					boundary that carries weight is the one around the credentials rather than the one around
					the addresses.
				</p>
				<p className="small muted">
