		...
		>
			...
			<section>
				...
				<p className="small muted">
					...
					<Link href="/docs/limits/">limitUsd</Link> at five dollars a day per agent until you say
...
`}</Code>
			...
			<section>
				...
				<p>
					...
					<Link href="/docs/webhooks/">Webhooks</Link> publish port <code>8787</code>, which takes
					signed requests only — and you only need it if something on the internet has to be able to
					wake an agent. Telegram and mail need nothing published at all, because they reach out
				...
				<div className="note">
					<p>
						...
						<Link href="/docs/trust/">Trust</Link> has the rest of what that does and does not
						claim.
					</p>
				</div>
			</section>
			...
			<section>
				...
				<p className="small muted">
					...
					connection, which is why <Link href="/docs/console/">the console</Link>,{" "}
					<Link href="/docs/serve/">a forwarded port</Link> and the log feed all behave identically
					either way.
				</p>
			</section>
		</Docs>
